...
abstract class CodeGenerator{
	...
	protected static function getModelTpl(){
		return __DIR__ . '/model.tpl';
	}
	...
	protected static function convertType($meta_type){
		$type = 'mixed';
		if(stripos($meta_type, 'char') !== false || stripos($meta_type, 'date') !== false || stripos($meta_type, 'bigint') !== false){
			$type = 'string';
